...
class Todo(object):
    ...
    def __init__(self, text="", done=False, id=None, created_at=None, updated_at=None):
        """
        初始化任务对象。
    ...
    def to_dict(self):
        ...
        -------
        dict
            包含 id、text、done、created_at、updated_at 字段的字典。
        """
        return {
            "id": self.id,
            "text": self.text,
    ...
    def __repr__(self):
        ...
        return "Todo(id={0}, text={1!r}, done={2})".format(self.id[:8], self.text, self.done)
